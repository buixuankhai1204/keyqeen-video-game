<div wire:init="loadPopularGames" class="popular-games text-sm grid grid-cols-6 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-12 border-b border-gray-800 pb-16">
    @forelse($popular_games as $game)
